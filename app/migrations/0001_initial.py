# Generated by Django 4.1.6 on 2023-05-09 02:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('STUDENT', 'Student'), ('CLUBREP', 'Club Representative'), ('ACCOUNTMAN', 'Account Manager'), ('CINEMAMAN', 'Cinema Manager')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filmImage', models.ImageField(default='', upload_to='filmImages/')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.club')),
                ('transactions', models.ManyToManyField(related_name='monthly_statement', to='app.transaction')),
            ],
        ),
        migrations.CreateModel(
            name='clubRequest',
